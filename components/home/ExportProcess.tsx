        ...
        <div className="mb-14 text-center">
          <div className="flex items-center justify-center gap-6 mb-2">
            <svg width="28" height="28" viewBox="0 0 28 28" fill="none" aria-hidden="true" className="hidden sm:block flex-shrink-0">
              <path d="M14 2C14 2 6 8 6 16C6 20.4 9.6 24 14 24C18.4 24 22 20.4 22 16C22 8 14 2 14 2Z" fill="#1C2417" opacity="0.3" />
              <path d="M14 2C14 2 6 8 6 16C6 20.4 9.6 24 14 24" stroke="#9B7733" strokeWidth="1" fill="none" />
            </svg>
            <SectionHeading eyebrow="How We Work" title="Our Export Process" align="center" />
            <svg width="28" height="28" viewBox="0 0 28 28" fill="none" aria-hidden="true" className="hidden sm:block flex-shrink-0">
              <path d="M14 2C14 2 22 8 22 16C22 20.4 18.4 24 14 24C9.6 24 6 20.4 6 16C6 8 14 2 14 2Z" fill="#1C2417" opacity="0.3" />
              <path d="M14 2C14 2 22 8 22 16C22 20.4 18.4 24 14 24" stroke="#9B7733" strokeWidth="1" fill="none" />
            </svg>
          </div>
